    ...
    switch response.b.body.collisionType
      when me.collision.types.WORLD_SHAPE
        ...
        if other.type == 'platform'
          if @body.falling and !me.input.isKeyPressed('down') and response.overlapV.y > 0 and ~~@body.vel.y >= ~~response.overlapV.y
...
game.CoinEntity = me.CollectableEntity.extend(
  init: (x, y, settings) ->
    ...
    @_super me.CollectableEntity, 'init', [
      x
      y
      settings
    ]
